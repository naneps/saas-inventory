  ...
  $.fn.fireModal = function (options) {
    ...
    this.each(function () {
      ...
      if (options.bodyClass)
        $(modal_template).find(".modal-body").addClass(options.bodyClass);

      // add footer body class
      if (options.footerClass)
        $(modal_template).find(".modal-footer").addClass(options.footerClass);
      ...
      if (modal_form.length) {
        ...
        if (options.autoFocus) {
          ...
          $(modal_template).on("shown.bs.modal", function () {
            ...
            if (typeof options.autoFocus == "boolean")
              modal_form
                .find("input:eq(0)")
                .focus(); // the first input element will be focused
        ...
        if (!modal_form.find("button").length)
          $(modal_form).append(
            '<button class="d-none" id="' + id + '-submit"></button>'
          );
